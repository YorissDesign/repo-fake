...
const fs = require('fs')
const { color } = require('./fake/color')
const {_wait, getBuffer, h2k, generateMessageID, banner, getGroupAdmins, getRandom, start, success, author, close } = require('./fake/functions');
...
const _gombal = JSON.parse(fs.readFileSync('./fake/data/gombal.json'));
const _welkom = JSON.parse(fs.readFileSync('./fake/data/welcome.json'))
